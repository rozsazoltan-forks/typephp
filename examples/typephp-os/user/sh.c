...
int main(int argc, char **argv)
{
    ...
    (void) write(STDOUT_FILENO,
        "Commands: ls, cd, pwd, date, uname, cat, echo, write, touch, mkdir, rm, rmdir, mv, memtest, systest, fault, vmfault, wrfault\n",
        sizeof("Commands: ls, cd, pwd, date, uname, cat, echo, write, touch, mkdir, rm, rmdir, mv, memtest, systest, fault, vmfault, wrfault\n") - 1);
    for (;;) {
        char *arguments[9];
